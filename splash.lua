...
function scene:enterScene(event)
	...
	func.LoadScreen("Login","slideRight")
...
function scene:createScene( event )
	...
	group:insert(func.SuperLabel({Caption="Version: " .. _G.VersionNumber,Underline=1,FontSize=30,Bold=1,Left=640/ 2-80,Height=20,Top=960 / 2 + 560,Red=99/255,Green=37/255,Blue=35/255}))
